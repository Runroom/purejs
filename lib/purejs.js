...
var setCookie = function setCookie(name, path, domain, secure) {
  var value = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
  var days = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 365;
...
var removeCookie = function removeCookie(name, path, domain, secure) {
